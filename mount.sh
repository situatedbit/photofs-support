...
BUNDLE_GEMFILE="$PHOTOFS_DEPLOY_PATH/latest/Gemfile" bundler exec ruby $PHOTOFS_DEPLOY_PATH/latest/mount.rb $PHOTOFS_MOUNT_PATH -o daemon,source=$PHOTOFS_SOURCE_PATH
